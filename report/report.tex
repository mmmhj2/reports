...
\[
    \begin{aligned}
        ...
        \end{bmatrix}^\top
        \begin{bmatrix}
            0 \\ L_2 \dot \theta_2 \\ L_2 \dot \theta_1 \cos \theta_2
        \end{bmatrix} \\
        = & \begin{bmatrix}
            {L_2} \dot\theta_2 \sin\theta_3\\
                {L_2} \dot\theta_2 \cos\theta_3\\
                {L_2} \dot\theta_1 \cos\theta_2
        \end{bmatrix}
    \end{aligned}
\]
...
我们依次计算连杆的质心速度，对连杆一，
\[
    \prescript{1}{}{v_{c_1}} = 0
\]
考虑到其惯性张量是对称的，其动能为
\[
    \mathcal T_1 
    = \frac{1}{2} (I_{xx,1} \omega_x^2 + I_{yy,1} \omega_y^2 + I_{zz,1} \omega_z^2) 
    = \frac{I_{zz,1}}{2} {\dot \theta_1}^2
\]

对连杆二，
\[
    \prescript{2}{}{v_{c_2}} = \begin{bmatrix}
        -\dot \theta_1 \sin\theta_2 \\
        -\dot \theta_1 \cos\theta_2 \\
        \dot \theta_2
    ...
    = \begin{bmatrix}
        ...
        \frac{1}{2} L_2 \dot \theta_1 \cos \theta_2
    \end{bmatrix}
\]
从而其动能为
\[
    \begin{aligned}
        \mathcal T_2 = & \frac{1}{8} m_2 L_2^2 (\dot \theta_2^2 + \dot\theta_1^2 \cos \theta_2) \\
...
\[
    \begin{aligned}
        ...
        &+ {{\left( {L_2} \cos\theta_2 \dot\theta_1-\frac{{L_3} \left( \cos\theta_2 \sin\theta_3 \dot\theta_1+\sin\theta_2 \cos\theta_3 \dot\theta_1\right) }{2}\right) }^{2}} \Big] \\
